...
function StageCard({
  ...
  return (
    <div
      className="flex-1 px-5 py-3 rounded-md border transition-all duration-300 relative overflow-hidden"
      style={{
        background: bg,
        borderColor,
    ...
    >
      ...
      <div
        className="relative text-[10px] font-mono mt-1.5 truncate leading-none h-3"
