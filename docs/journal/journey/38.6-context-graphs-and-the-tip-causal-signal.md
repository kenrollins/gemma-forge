...
[Memory feedback `feedback_non_determinism_has_cost`](../../../memory/feedback_non_determinism_has_cost.md) says: not everything should be an LLM; deterministic code belongs where correctness must be trustable. The judge is an LLM call. Two reasons it earns its place anyway:
