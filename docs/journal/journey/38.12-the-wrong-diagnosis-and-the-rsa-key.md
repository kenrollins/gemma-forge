...
- [`config/harness.yaml`](../../config/harness.yaml) — unchanged; the symlink at the canonical key path means the harness automatically uses the FIPS-compatible RSA key.
