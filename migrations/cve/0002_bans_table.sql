-- migrations/cve/0002_bans_table.sql
--
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE bans TO forge_cve;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE bans_id_seq TO forge_cve;
