-- migrations/detection/0001_base_schema.sql
--
-- Phase B baseline schema for the `detection` skill inside the gemma_forge
...
-- lands in the detection schema (forge_admin has no privilege on public).
...
CREATE TABLE IF NOT EXISTS runs (
    ...
    skill         TEXT NOT NULL DEFAULT 'detection',
...
-- ---------------------------------------------------------------------------
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA detection TO forge_detection;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA detection TO forge_detection;
