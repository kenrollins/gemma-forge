-- migrations/stig/0001_base_schema.sql
--
-- Phase B baseline schema for the `stig` skill inside the gemma_forge
...
-- lands in the stig schema (forge_admin has no privilege on public).
...
CREATE TABLE IF NOT EXISTS runs (
    ...
    skill         TEXT NOT NULL DEFAULT 'stig',
...
-- ---------------------------------------------------------------------------
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA stig TO forge_stig;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA stig TO forge_stig;
