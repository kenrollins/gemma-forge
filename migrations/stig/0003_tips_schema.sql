-- migrations/stig/0003_tips_schema.sql
--
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE tips TO forge_stig;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE tip_retrievals TO forge_stig;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE tips_id_seq TO forge_stig;
GRANT USAGE, SELECT, UPDATE ON SEQUENCE tip_retrievals_id_seq TO forge_stig;
